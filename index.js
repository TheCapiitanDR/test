...
/*=====================================================[ CONNECTING  ]==============================================================*/                  	    
	    	...
	    	console.log(color(`[❗] SUBSCRIBE YOUTUBE SMART BOT`, 'aqua'))
         	...
         	nayla.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, `Successfully connected with your WhatsApp, don't forget to subscribe https://youtube.com/c/DanilZey for more update`, MessageType.text)
...
╭─⧉ *THANKS TO* ⧉
├◪ 
│❒ AHMAD SKYLORD (Danilzey) 
│❒ ANA LESTARI (Doi Gua) 
│❒ DANILZEY (LestariBotz) 
│❒ ARA-ARA
│❒ ZEEONE
│❒ ALFAGANZ
│❒ MANIK
...
/*====================================================[ CASE BY NAYLA ]==============================================================*/                    	                                          
   	...
   	case 'videolist':  
        ...
        case 'creator':  
		            ...
		            nayla.sendMessage(from, 'TUHH NOMER PACARKU KU [(>_<)] JANGAN DI AMBIL YAA AKU LAGI MONDOK',MessageType.text, { quoted: nay} )
		            break  
       case 'other':  
       case 'author':  
                    if (!isElite) return reply(mess.only.userB)
